    ...
    if (nome.trim() === '' || sobrenome.trim() === '' || whatsapp.trim() === '') {
        ...
        if (telefoneNumerico.length !== 11) {
            ...
            if (confirmacao) {
                ...
                const urlEnvio = `envio.html?nome=${encodeURIComponent(nome)}&sobrenome=${encodeURIComponent(sobrenome)}&whatsapp=${encodeURIComponent(whatsapp)}&itens=${encodeURIComponent(itens)}&totalValor=${encodeURIComponent(totalValor)}&totalPeso=${encodeURIComponent(totalPeso)}`;
