...
function validarCampos() {
    ...
    if (nome.trim() === '' || sobrenome.trim() === '' || whatsapp.trim() === '') {
        ...
        if (telefoneNumerico.length !== 11) {
            ...
            if (confirmacao) {
                preencherCamposOcultos(); // Chamar a função para preencher os campos ocultos
            } else {
                return;
            }
        }
...
// Função para preencher os campos ocultos com os dados do formulário de cadastro
function preencherCamposOcultos() {
    ...
    // Preencher os campos ocultos no formulário com os valores obtidos
    document.getElementById('hiddenNome').value = nome;
    document.getElementById('hiddenSobrenome').value = sobrenome;
    document.getElementById('hiddenWhatsapp').value = whatsapp;

    document.getElementById('formDadosOcultos').submit(); // Submeter o formulário oculto após preencher os campos
}