...
function finalizarCompra() {
    // Exibir um prompt de confirmação ao usuário
    const confirmacao = window.confirm('Tem certeza que deseja finalizar a compra?');

    // Verificar se o usuário confirmou a finalização da compra
    if (confirmacao) {
        ...
        // Ação cancelada se o usuário clicar em "Cancelar" no prompt de confirmação
        return;
    }
}
